@require =
	base-url: '/port/resources/pub/js/lib'
	paths:
		#paths
		config : \../config/
		app : \../app/
	...
	shim:
			...
			'ang.aria':           deps: <[ angular ]>
			'ang.cookies':        deps: <[ angular ]>
			'ang.csp':            deps: <[ angular ]>
			'ang.loader':         deps: <[ angular ]>
			'ang.messages':       deps: <[ angular ]>
			'ang.mocks':          deps: <[ angular ]>
			'ang.ngRoute':        deps: <[ angular ang.resource ]>
			'ang.resource':       deps: <[ angular ]>
			'ang.sanitize':       deps: <[ angular ]>
			'ang.scenario':       deps: <[ angular ]>
			'ang.touch':          deps: <[ angular ]>
